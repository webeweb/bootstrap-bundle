...
use WBW\Bundle\BootstrapBundle\Twig\Extension\Utility\TableButtonTwigExtensionTrait;
...
class TestTableButtonTwigExtensionTrait {
    ...
    use TableButtonTwigExtensionTrait {
        setTableButtonTwigExtension as public;
    }
}
