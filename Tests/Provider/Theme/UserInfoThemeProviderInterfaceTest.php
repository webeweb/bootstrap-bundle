 ...
 * @final
 */
final class UserInfoThemeProviderInterfaceTest extends AbstractFrameworkTestCase {
    ...
    public function testConstruct() {
        ...
        $this->assertEquals("webeweb.bootstrap.provider.theme.userinfo", UserInfoThemeProviderInterface::SERVICE_NAME);
    }
