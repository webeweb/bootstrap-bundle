 ...
 * @final
 */
final class BreadcrumbsThemeProviderInterfaceTest extends AbstractFrameworkTestCase {
    ...
    public function testConstruct() {
        ...
        $this->assertEquals("webeweb.bootstrap.provider.theme.breadcrumbs", BreadcrumbsThemeProviderInterface::SERVICE_NAME);
    }
