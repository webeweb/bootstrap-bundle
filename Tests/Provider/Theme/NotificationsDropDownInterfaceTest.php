 ...
 * @final
 */
final class NotificationsDropDownThemeProviderInterfaceTest extends AbstractFrameworkTestCase {
    ...
    public function testConstruct() {
        ...
        $this->assertEquals("webeweb.bootstrap.provider.theme.notificationsdropdown", NotificationsDropDownThemeProviderInterface::SERVICE_NAME);
    }
