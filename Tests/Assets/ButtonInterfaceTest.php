...
class ButtonInterfaceTest extends AbstractTestCase {
    ...
    public function test__construct(): void {
        ...
        $this->assertEquals(WBWBootstrapInterface::BOOTSTRAP_TYPE_DANGER, ButtonInterface::BUTTON_TYPE_DANGER);
        ...
        $this->assertEquals(WBWBootstrapInterface::BOOTSTRAP_TYPE_INFO, ButtonInterface::BUTTON_TYPE_INFO);
        ...
        $this->assertEquals(WBWBootstrapInterface::BOOTSTRAP_TYPE_SUCCESS, ButtonInterface::BUTTON_TYPE_SUCCESS);
        $this->assertEquals(WBWBootstrapInterface::BOOTSTRAP_TYPE_WARNING, ButtonInterface::BUTTON_TYPE_WARNING);
    }
}
