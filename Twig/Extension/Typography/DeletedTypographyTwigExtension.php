 ...
 */
class DeletedTypographyTwigExtension extends AbstractTypographyTwigExtension {
     ...
     * @var string
     */
    const SERVICE_NAME = "webeweb.bootstrapbundle.twig.extension.typography.deleted";
